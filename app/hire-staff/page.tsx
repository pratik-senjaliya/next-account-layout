...
import { getAllHireStaffPositions } from "@/lib/hire-staff";
import Link from "next/link";

export const metadata: Metadata = genMeta({
  title: "Hire Offshore Staff - Accounting & Finance Professionals",
  description:
    "Expand your capacity with skilled offshore bookkeepers, tax preparers, and CFO-level professionals working from our state-of-the-art delivery centers.",
});

export default function HireStaffHubPage() {
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {positions.map((position, index) => (
              <Link key={position.id} href={`/hire-staff/${position.slug}`} className="group">
