...
export const metadata: Metadata = genMeta({
  ...
  description:
    "Discover our full suite of financial, tax, and strategic business industrys designed to help you scale efficiently.",
});

export default function ServicesHubPage() {
  const industrys = getAllIndustries();

  const commonFAQ = [
    {
      question: "How do I know which industry is right for my business?",
      answer: "We offer a free initial consultation to assess your business's current state and long-term goals. Based on this assessment, we recommend a tailored combination of industrys.",
    },
    {
      question: "Can I bundle multiple industrys?",
    ...
    {
      question: "Are your industrys available for international businesses?",
  ...
  const genericProcess = [
    ...
    { step: "02", title: "Custom Proposal", description: "We draft a strategy and industry package tailored specifically to your objectives." },
  ...
  return (
    <>
      ...
      <Section background="gray" spacing="lg" id="all-industrys">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {industrys.map((industry, index) => (
              <Link key={industry.id} href={`/industrys/${industry.slug}`} className="group">
